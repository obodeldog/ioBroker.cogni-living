...
async function processSensorEvent(adapter, id, state, deviceConf) {
    ...
    const eventObj = { timestamp: now, id: id, name: deviceConf.name, type: deviceConf.type, location: deviceConf.location, value: value,
        isBathroomSensor: deviceConf.isBathroomSensor || false,
        isKitchenSensor:  deviceConf.isKitchenSensor  || false,
        isFP2Bed:         deviceConf.isFP2Bed         || false,
        isFP2Living:      deviceConf.isFP2Living       || false,
        isVibrationBed:   deviceConf.isVibrationBed    || false,
    };
