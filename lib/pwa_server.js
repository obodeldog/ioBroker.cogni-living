...
function renderData(d) {
  ...
  if (nq) {
    ...
    // Farb-Logik: Ruhig=grün / Leicht unruhig oder Bad=orange / Unruhig+aktiv+wach=rot
    if (lower.includes('ruhig') && !lower.includes('unruhig') && !lower.includes('leicht')) {
      nightEl.style.color = '#00e676'; // grün
    } else if (lower.includes('leicht') || lower.includes('bad') || lower.includes('normal')) {
      nightEl.style.color = '#ffab00'; // orange
    } else if (lower.includes('unruhig') || lower.includes('aktiv') || lower.includes('wach') || lower.includes('viel')) {
      nightEl.style.color = '#ff3d3d'; // rot
    } else {
