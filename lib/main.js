                ...
                try {
                    ...
                    if (this.isProVersion) {
                        ...
                        if (s && s.val) {
                            ...
                            const healthProfiles = this.config.healthProfiles || {};
                            const enabledProfiles = Object.keys(healthProfiles).filter(k => healthProfiles[k]?.enabled);
                            if (enabledProfiles.length > 0 && digests.length >= 5) {
