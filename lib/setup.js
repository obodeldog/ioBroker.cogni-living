...
async function createAllObjects(adapter) {
    ...
    await adapter.setObjectNotExistsAsync('analysis.health.anomalyScore', { type: 'state', common: { name: 'Health Anomaly Score', type: 'number', role: 'value', read: true, write: false }, native: {} });
    await adapter.setObjectNotExistsAsync('analysis.health.lastNightNormal', { type: 'state', common: { name: 'Last Night Normal for Person', type: 'boolean', role: 'indicator', read: true, write: false }, native: {} });
