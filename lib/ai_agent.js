...
async function sendMorningBriefing(adapter) {
    ...
    try {
        ...
        const filePath = _path.join(dataDir, `${yesterdayStr}.json`);
        let night = {};
        ...
        const sleepStart = night.sleepWindowStart ? fmt(night.sleepWindowStart) : null;
        const sleepEnd   = night.sleepWindowEnd   ? fmt(night.sleepWindowEnd)   : null;
