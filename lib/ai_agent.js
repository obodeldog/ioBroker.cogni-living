...
async function generateHealthReport(adapter, reportType) {
    ...
    if (reportType === 'NIGHT') {
        ...
        promptTask = `Analysiere diese Events des TAGES (ab ${startHour} Uhr). Aktivit\u00e4t? Mahlzeiten? Haust\u00fcr? Schreibe den Bericht \u00fcber die Person direkt (nutze den Namen aus dem Kontext, nie 'Ihre Mutter' oder 'der Bewohner'). Max 2 S\u00e4tze, Flie\u00dftext.`;
    }
