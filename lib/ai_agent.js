...
async function generateHealthReport(adapter, reportType) {
    ...
    if (reportType === 'NIGHT') {
        ...
        promptTask = "Analysiere diese Events des TAGES (08:00-Jetzt). Aktivität? Mahlzeiten? Haustür? Schreibe den Bericht über die Person direkt (nutze den Namen aus dem Kontext, nie 'Ihre Mutter' oder 'der Bewohner'). Max 2 Sätze, Fließtext.";
    }
    ...
    const userContext = adapter.config?.aiContext || 'Primärer Nutzer: Marc (47 Jahre), allein im Haus.';
