...
interface SettingsState {
    ...
    selectIdContext: 'device' | 'presence' | 'simulation' | 'outdoor' | null; // NEU: 'outdoor' context
...
export default class Settings extends React.Component<SettingsProps, SettingsState> {
    constructor(props: SettingsProps) {
        ...
        this.state = {
            ...
            outdoorSensorId: native.outdoorSensorId || '', // NEU
    ...
    // NEW: Open SelectID for Outdoor Sensor
        ...
        return (
            <Box>
                        ...
                        <TableBody>
                            {this.state.devices.map((device, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell><Tooltip title="Ist dies eine Haustür? (Checkt Abwesenheit)"><Checkbox checked={device.isExit || false} icon={<LogoutIcon fontSize='small' sx={{color: 'action.disabled'}} />} checkedIcon={<LogoutIcon fontSize='small' color='primary' />} onChange={e => this.onDeviceChange(index, 'isExit', e.target.checked)} size="small"/></Tooltip></TableCell>
                ...
                <Box sx={{ display: 'flex', gap: 2, mt: 2, justifyContent: 'space-between', alignItems: 'center' }}>
                    <Box><Button variant="contained" color="secondary" startIcon={<AutoFixHighIcon />} onClick={this.handleOpenWizard} sx={{ mr: 1 }}>Auto-Discovery</Button><Button variant="outlined" startIcon={<AddIcon />} onClick={() => this.onAddDevice()}>Neu</Button></Box>
