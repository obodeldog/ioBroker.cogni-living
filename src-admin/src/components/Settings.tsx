...
// --- SICHERE IMPORTS (Direct Imports verhindern Abstürze) ---
...
import SensorsIcon from '@mui/icons-material/Sensors'; // Falls das fehlt, nutzen wir unten ListIcon als Fallback
...
import BuildIcon from '@mui/icons-material/Build'; // Ersatz für Science
